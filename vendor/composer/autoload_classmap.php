...
return array(
    'AdminMiddleware' => $baseDir . '/src/security/AdminMiddleware.php',
    'Alternativa' => $baseDir . '/src/model/Alternativa.php',
    'AlternativaAssociacao' => $baseDir . '/src/model/AlternativaAssociacao.php',
    'AlternativaAssociacaoDAO' => $baseDir . '/src/dao/AlternativaAssociacaoDAO.php',
    'AlternativaController' => $baseDir . '/src/controller/AlternativaController.php',
    'AlternativaDAO' => $baseDir . '/src/dao/AlternativaDAO.php',
    'AlternativaDTO' => $baseDir . '/src/dto/AlternativaDTO.php',
    'AlternativaMarcada' => $baseDir . '/src/model/AlternativaMarcada.php',
    'AlternativaMarcadaController' => $baseDir . '/src/controller/AlternativaMarcadaController.php',
    'AlternativaMarcadaDAO' => $baseDir . '/src/dao/AlternativaMarcadaDAO.php',
    'AlternativaMarcadaDTO' => $baseDir . '/src/dto/AlternativaMarcadaDTO.php',
    'AlternativaMarcadaService' => $baseDir . '/src/service/AlternativaMarcadaService.php',
    'AlternativaMultiplaEscolha' => $baseDir . '/src/model/AlternativaMultiplaEscolha.php',
    'AlternativaMultiplaEscolhaDAO' => $baseDir . '/src/dao/AlternativaMultiplaEscolhaDAO.php',
    'AlternativaOrdenacao' => $baseDir . '/src/model/AlternativaOrdenacao.php',
    'AlternativaOrdenacaoDAO' => $baseDir . '/src/dao/AlternativaOrdenacaoDAO.php',
    'AlternativaService' => $baseDir . '/src/service/AlternativaService.php',
    'App\\Middleware\\CorsMiddleware' => $baseDir . '/src/config/CorsMiddleware.php',
    'Attribute' => $vendorDir . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Conexao' => $baseDir . '/src/config/Conexao.php',
    ...
    'Distintivo' => $baseDir . '/src/model/Distintivo.php',
    'DistintivoAdquirido' => $baseDir . '/src/model/DistintivoAdquirido.php',
    'DistintivoAdquiridoController' => $baseDir . '/src/controller/DistintivoAdquiridoController.php',
    'DistintivoAdquiridoDAO' => $baseDir . '/src/dao/DistintivoAdquiridoDAO.php',
    'DistintivoAdquiridoDTO' => $baseDir . '/src/dto/DistintivoAdquiridoDTO.php',
    'DistintivoAdquiridoService' => $baseDir . '/src/service/DistintivoAdquiridoService.php',
    'DistintivoController' => $baseDir . '/src/controller/DistintivoController.php',
    'DistintivoDAO' => $baseDir . '/src/dao/DistintivoDAO.php',
    'DistintivoDTO' => $baseDir . '/src/dto/DistintivoDTO.php',
    'DistintivoService' => $baseDir . '/src/service/DistintivoService.php',
    ...
    'JwtMiddleware' => $baseDir . '/src/security/JwtMiddleware.php',
    'Missao' => $baseDir . '/src/model/Missao.php',
    'MissaoAtividade' => $baseDir . '/src/model/MissaoAtividade.php',
    'MissaoAtividadeDAO' => $baseDir . '/src/dao/MissaoAtividadeDAO.php',
    'MissaoAtividadeDTO' => $baseDir . '/src/dto/MissaoAtividadeDTO.php',
    'MissaoAtividadeTarefa' => $baseDir . '/src/model/MissaoAtividadeTarefa.php',
    'MissaoAtividadeTarefaDAO' => $baseDir . '/src/dao/MissaoAtividadeTarefaDAO.php',
    'MissaoAtividadeTarefaDTO' => $baseDir . '/src/dto/MissaoAtividadeTarefaDTO.php',
    'MissaoConteudo' => $baseDir . '/src/model/MissaoConteudo.php',
    'MissaoConteudoDAO' => $baseDir . '/src/dao/MissaoConteudoDAO.php',
    'MissaoConteudoDTO' => $baseDir . '/src/dto/MissaoConteudoDTO.php',
    'MissaoController' => $baseDir . '/src/controller/MissaoController.php',
    'MissaoDAO' => $baseDir . '/src/dao/MissaoDAO.php',
    'MissaoDTO' => $baseDir . '/src/dto/MissaoDTO.php',
    'MissaoService' => $baseDir . '/src/service/MissaoService.php',
    'Ocupacao' => $baseDir . '/src/model/Ocupacao.php',
    'OcupacaoController' => $baseDir . '/src/controller/OcupacaoController.php',
    'OcupacaoDAO' => $baseDir . '/src/dao/OcupacaoDAO.php',
    'OcupacaoDTO' => $baseDir . '/src/dto/OcupacaoDTO.php',
    'OcupacaoService' => $baseDir . '/src/service/OcupacaoService.php',
    ...
    'ProgressoMissao' => $baseDir . '/src/model/ProgressoMissao.php',
    'ProgressoMissaoAtividade' => $baseDir . '/src/model/ProgressoMissaoAtividade.php',
    'ProgressoMissaoAtividadeDAO' => $baseDir . '/src/dao/ProgressoMissaoAtividadeDAO.php',
    'ProgressoMissaoAtividadeDTO' => $baseDir . '/src/dto/ProgressoMissaoAtividadeDTO.php',
    'ProgressoMissaoController' => $baseDir . '/src/controller/ProgressoMissaoControler.php',
    'ProgressoMissaoDAO' => $baseDir . '/src/dao/ProgressoMissaoDAO.php',
    'ProgressoMissaoDTO' => $baseDir . '/src/dto/ProgressoMissaoDTO.php',
    'ProgressoMissaoService' => $baseDir . '/src/service/ProgressoMissaoService.php',
    'Questao' => $baseDir . '/src/model/Questao.php',
    'QuestaoController' => $baseDir . '/src/controller/QuestaoController.php',
    'QuestaoDAO' => $baseDir . '/src/dao/QuestaoDAO.php',
    'QuestaoDTO' => $baseDir . '/src/dto/QuestaoDTO.php',
    'QuestaoService' => $baseDir . '/src/service/QuestaoService.php',
    'RecuperacaoSenha' => $baseDir . '/src/model/RecuperacaoSenha.php',
    'RecuperacaoSenhaController' => $baseDir . '/src/controller/RecuperacaoSenhaController.php',
    'RecuperacaoSenhaDAO' => $baseDir . '/src/dao/RecuperacaoSenhaDAO.php',
    'RecuperacaoSenhaService' => $baseDir . '/src/service/RecuperacaoSenhaService.php',
    'RegraDeNegocioException' => $baseDir . '/src/exception/RegraDeNegocioException.php',
    'Request' => $baseDir . '/src/config/http/Request.php',
    'Response' => $baseDir . '/src/config/http/Response.php',
    'Router' => $baseDir . '/src/config/router/Router.php',
    ...
    'Tematica' => $baseDir . '/src/model/Tematica.php',
    'TematicaController' => $baseDir . '/src/controller/TematicaController.php',
    'TematicaDAO' => $baseDir . '/src/dao/TematicaDAO.php',
    'TematicaDTO' => $baseDir . '/src/dto/TematicaDTO.php',
    'TematicaService' => $baseDir . '/src/service/TematicaService.php',
    ...
    'Usuario' => $baseDir . '/src/model/Usuario.php',
    'UsuarioController' => $baseDir . '/src/controller/UsuarioController.php',
    'UsuarioDAO' => $baseDir . '/src/dao/UsuarioDAO.php',
